...
public abstract class DamqRcvConsumer implements Runnable {
	...
	public void run() {
		...
		while (true) {
			try {
				...
				logger.debug("receive cmd : " + jo.toString());
	...
	protected abstract void MainProc(String org, String dst, String dateTime, String msgId, String msgType,
			String workCode, String msgBody);
